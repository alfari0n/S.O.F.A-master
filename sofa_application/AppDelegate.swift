...
//  sofa_application
//
//  Created by Kirill Milititskiy on 14.07.17.
...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        GMSServices.provideAPIKey("AIzaSyAKXZFrbSliv7DYuMVcmeB5PaVO1svuqcg")
        GMSPlacesClient.provideAPIKey("AIzaSyAKXZFrbSliv7DYuMVcmeB5PaVO1svuqcg")
